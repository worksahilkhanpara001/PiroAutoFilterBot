...
API_ID = int(environ.get('API_ID', '15316932'))
API_HASH = environ.get('API_HASH', 'a000d8674954e438b374ec7772040827')
BOT_TOKEN = environ.get('BOT_TOKEN', '6725616138:AAFuB5Hr_IaoG5i0pljuIBIsT6HzvUF-r2o')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5304353210').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL','-1002139708284')
auth_grp = environ.get('AUTH_GROUP','-1001986991921')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002139708284')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001986991921')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = -1002139708284
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002015111389'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'bolly4u_support')
